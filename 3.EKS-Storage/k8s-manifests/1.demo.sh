Delete_cluster: eksdemo delete cluster hanuman-cluster


eksdemo create cluster hanumans-eks --region eu-west-2 -i t3.medium
...
data.aws_vpc.default_vpc: Read complete after 1s [id=vpc-0a031c45d2fad6717]
 ...
 <= data "aws_eks_cluster" "deme_eks" {
  ...
  + resource "aws_eks_cluster" "demo_eks" {
      ...
      + vpc_config {
          ...
          + subnet_ids                = [
              + "subnet-050be6267913272ae",
              + "subnet-081a96e3e81f08e76",
            ]
...
aws_iam_role_policy_attachment.demo_eks_AmazonEKSClusterPolicy: Creation complete after 0s [id=eksClusterRole-20241005213157154500000001]
aws_iam_role_policy_attachment.demo_eks_AmazonEKSVPCResourceController: Creation complete after 0s [id=eksClusterRole-20241005213157166300000002]
aws_eks_cluster.demo_eks: Creating...
aws_iam_role.node_instance_role: Creation complete after 0s [id=eks-demo-node]
aws_iam_instance_profile.node_instance_profile: Creating...
tls_private_key.key_pair: Creation complete after 2s [id=127e6e7ad547ae9ddc95cd0fadb532f586648300]
aws_key_pair.eks_kp: Creating...
local_sensitive_file.pem_file: Creating...
local_sensitive_file.pem_file: Creation complete after 0s [id=80767c0ec4ca2fca425166540f61cdb7bfaf2db9]
aws_iam_instance_profile.node_instance_profile: Creation complete after 1s [id=NodeInstanceProfile]
aws_key_pair.eks_kp: Creation complete after 0s [id=eks_kp]
aws_security_group.node_security_group: Creation complete after 1s [id=sg-0caa56e0a8e8a6ef1]
...
aws_vpc_security_group_ingress_rule.node_security_group_ingress: Creation complete after 1s [id=sgr-06384f51e2dec9b46]
aws_launch_template.node_launch_template: Creation complete after 1s [id=lt-02189c0525d0e1b8a]
time_sleep.wait_30_seconds: Creating...
aws_vpc_security_group_egress_rule.node_egress_all: Creation complete after 1s [id=sgr-0336acf6f75455ad3]
...
time_sleep.wait_30_seconds: Creation complete after 30s [id=2024-10-05T21:32:28Z]
...
aws_cloudformation_stack.autoscaling_group: Creation complete after 26s [id=arn:aws:cloudformation:us-east-1:381492023386:stack/eks-cluster-stack/5282e0b0-8361-11ef-8a72-125fd6546fb9]
...
aws_eks_cluster.demo_eks: Still creating... [1m30s elapsed]
aws_eks_cluster.demo_eks: Still creating... [1m40s elapsed]
aws_eks_cluster.demo_eks: Still creating... [1m50s elapsed]
aws_eks_cluster.demo_eks: Still creating... [2m0s elapsed]
aws_eks_cluster.demo_eks: Still creating... [2m10s elapsed]
aws_eks_cluster.demo_eks: Still creating... [2m20s elapsed]
aws_eks_cluster.demo_eks: Still creating... [2m30s elapsed]
aws_eks_cluster.demo_eks: Still creating... [2m40s elapsed]
aws_eks_cluster.demo_eks: Still creating... [2m50s elapsed]
aws_eks_cluster.demo_eks: Still creating... [3m0s elapsed]
aws_eks_cluster.demo_eks: Still creating... [3m10s elapsed]
aws_eks_cluster.demo_eks: Still creating... [3m20s elapsed]
aws_eks_cluster.demo_eks: Still creating... [3m30s elapsed]
aws_eks_cluster.demo_eks: Still creating... [3m40s elapsed]
aws_eks_cluster.demo_eks: Still creating... [3m50s elapsed]
aws_eks_cluster.demo_eks: Still creating... [4m0s elapsed]
aws_eks_cluster.demo_eks: Still creating... [4m10s elapsed]
aws_eks_cluster.demo_eks: Still creating... [4m20s elapsed]
aws_eks_cluster.demo_eks: Still creating... [4m30s elapsed]
aws_eks_cluster.demo_eks: Still creating... [4m40s elapsed]
aws_eks_cluster.demo_eks: Still creating... [4m50s elapsed]
aws_eks_cluster.demo_eks: Still creating... [5m0s elapsed]
aws_eks_cluster.demo_eks: Still creating... [5m10s elapsed]
aws_eks_cluster.demo_eks: Still creating... [5m20s elapsed]
aws_eks_cluster.demo_eks: Still creating... [5m30s elapsed]
aws_eks_cluster.demo_eks: Still creating... [5m40s elapsed]
aws_eks_cluster.demo_eks: Still creating... [5m50s elapsed]
aws_eks_cluster.demo_eks: Still creating... [6m0s elapsed]
aws_eks_cluster.demo_eks: Still creating... [6m10s elapsed]
aws_eks_cluster.demo_eks: Still creating... [6m20s elapsed]
aws_eks_cluster.demo_eks: Still creating... [6m30s elapsed]
aws_eks_cluster.demo_eks: Still creating... [6m40s elapsed]
aws_eks_cluster.demo_eks: Still creating... [6m50s elapsed]
aws_eks_cluster.demo_eks: Still creating... [7m0s elapsed]
aws_eks_cluster.demo_eks: Still creating... [7m10s elapsed]
aws_eks_cluster.demo_eks: Creation complete after 7m13s [id=demo-eks]
data.aws_eks_cluster.deme_eks: Reading...
data.aws_eks_cluster.deme_eks: Read complete after 1s [id=demo-eks]
...
aws_vpc_security_group_ingress_rule.cluster_control_plane_security_group_ingress: Creation complete after 0s [id=sgr-0e349de445b0aae0d]
aws_vpc_security_group_ingress_rule.control_plane_egress_to_node_security_group_on_443: Creation complete after 0s [id=sgr-06b35fc19595b7b3c]
aws_vpc_security_group_egress_rule.control_plane_egress_to_node_security_group: Creation complete after 0s [id=sgr-06da85d7df9737252]
aws_vpc_security_group_ingress_rule.node_security_group_from_control_plane_ingress: Creation complete after 0s [id=sgr-06a80325234dfafd8]
aws_vpc_security_group_egress_rule.control_plane_egress_to_node_security_group_on_443: Creation complete after 0s [id=sgr-0f6b2c56f804d6ffa]

Apply complete! Resources: 20 added, 0 changed, 0 destroyed.

Outputs:

NodeAutoScalingGroup = "eks-cluster-stack-NodeGroup-ZgDYudLTiFF4"
NodeInstanceRole = "arn:aws:iam::381492023386:role/eks-demo-node"
NodeSecurityGroup = "sg-0caa56e0a8e8a6ef1"

root@aws-client amazon-elastic-kubernetes-service-course/eks on  main [!] via 💠 default on ☁️  (us-east-1) ➜
